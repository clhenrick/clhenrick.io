...
{% image 'illustrator-rect-crop.png', 'drawing and selecting a map frame in illustrator' %}
...
{% image 'illustrator-transform-panel.png', 'transform window example' %}
...
{% image 'd3-print-ai-layers-panel.png', 'screenshot of layers panel' %}
...
{% image 'd3-print-ai-layers-panels-map-layers.png', 'screenshot of layers panel with map layers' %}
...
{% image 'd3-print-ai-map-template.png', 'screenshot of map template' %}
...
{% image 'd3-print-ai-final-map.png', 'screenshot of finished map' %}
